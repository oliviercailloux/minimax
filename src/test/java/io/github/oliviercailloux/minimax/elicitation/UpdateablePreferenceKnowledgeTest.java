...
public class UpdateablePreferenceKnowledgeTest {
  ...
  void settingWeightsTest() {
    ...
    final ImmutableMap<Voter,
        VoterStrictPreference> profile = ImmutableMap.of(v1, VoterStrictPreference.given(v1, p), v2,
            VoterStrictPreference.given(v2, p), v3, VoterStrictPreference.given(v3, p), v4,
            VoterStrictPreference.given(v4, p));
    ...
    UpdateablePreferenceKnowledge startingKnowledge = UpdateablePreferenceKnowledge
        .given(ImmutableSet.copyOf(p), ImmutableSet.of(v1, v2, v3, v4));
