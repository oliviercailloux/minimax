...
class RunnerTests {
  ...
  public static void main(String[] args) throws Exception {
    ...
    final Run run = JsonConverter
        .toRuns(Files.readString(
            Path.of("experiments/TableLinearity/Css, sushi.soc, k = 100000, ongoing.json")))
        .getRun(0);
  ...
  void test() {
    ...
    /**
     * After first question, the regret is still 1d, with the adversary using weights (1d, 0d, 0d).
     */
