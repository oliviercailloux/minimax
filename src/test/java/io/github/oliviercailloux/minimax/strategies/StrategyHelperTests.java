...
public class StrategyHelperTests {
  ...
  void testGetIncomparablePairs() throws Exception {
    final ImmutableGraph.Builder<Alternative> builder =
        GraphBuilder.directed().<Alternative>immutable();
    ...
    assertEquals(ImmutableSet.of(EndpointPair.unordered(a2, a3)),
        StrategyHelper.getIncomparablePairs(graph));
  }
