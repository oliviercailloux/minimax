...
public class VoterStrictPreference {
   ...
   * @param rankedAlternatives with the preferred alternative as first element (may be empty).
  ...
  /**
   * Returns the alternatives this preference is about, the most preferred one first.
   *
  ...
  /**
   * Returns the number of alternatives, or equivalently, of ranks, this preference is about.
   *
   * @return ≥ 0.
   */
  public int size() {
   ...
   * @return ≥ 1.
   * @throws IllegalArgumentException if the given alternative is not in this preference.
   */
  ...
  public String toString() {
    return MoreObjects.toStringHelper(this).add("voter", voter).add("preference", preference)
        .toString();
  }
}
