...
public class AnalyzeQuestions {
  ...
  public static void main(String[] args) throws Exception {
    ...
    final ImmutableList<String> fileNames =
        ImmutableList.of("m5n20.json", "m10n20.json", "m11n30.json", "tshirts.json", "courses.json",
            "m9n146.json", "m14n9.json", "skate.json", "m15n30.json");
  ...
  public void analyzeQuestionsRegret(ImmutableList<String> fileNames, Path fileOut, Path dir)
      throws Exception {
    ...
    writer.writeHeaders("file", "m", "n", "avgQuestComTR", "cTR σ", "Q1TR", "MTR", "Q3TR",
        "avgTotQstTR", "qTR σ", "avgQuestComZR", "cZR σ", "Q1ZR", "MZR", "Q3ZR", "avgTotQstZR",
        "qZR σ", "runs");
  ...
  /**
   * Given a run, it finds qTR and qZR which are, respectively, the question such that the regret
   * reaches a specific threshold of regret and such that it reaches zero regret.
   * 
   * It should be improved. If it does not reach the threshold/zero maybe we want it to return
   * something different.
   */
  ...
  /**
   * Given a run, it builds a partial statistic of the questions from 0 to qTR, and a partial
   * statistic of questions from 0 to qZR.
   * 
   * It should be improved. If it does not reach the threshold/zero maybe we want it to return
   * something different.
   */
  ...
  private class PartialStatisticsRun {
    ...
    public PartialStatisticsRun(int questionsComm, double quantile1, double quantile2,
        double quantile3, int totQuestions) {
