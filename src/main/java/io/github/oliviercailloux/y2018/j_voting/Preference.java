 ...
 * Two alternatives can be equally ranked. There cannot be twice the same alternative.
 *
 */
public class Preference {
  ...
  /**
   * @param preferences {@code not null} a list of sets of alternatives. In a set, the alternatives
   *        are equally ranked. The sets are sorted by preference in the list. If an alternative is
   *        present several times, an IllegalArgumentException is thrown.
   */
  ...
  /**
   * @param p {@code not null}
   * @return whether the preferences are about the same alternatives exactly (not necessarily in the
   *         same order).
   */
  ...
  /**
   * @param p {@code not null}
   * @return whether the parameter preference contains all the alternatives in the calling
   *         preference
   */
  ...
  /**
   *
   * @param alter not {@code null}. If the alternative is not in the preference, it throws an
   ...
   * @return a set of alternatives containing all the alternatives of the list of set of alternative
   *         given. If an alternative appears several times in the list of sets, it appears only
   *         once in the new set.
   */
  ...
  /**
   *
   * @return the StrictPreference built from the preference if the preference is strict. If the
   *         preference is not strict it throws an IllegalArgumentException.
   */
