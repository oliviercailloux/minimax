...
/**
 * This class is immutable Contains a list of Alternatives sorted by preferences Two alternatives
 * can't be equally ranked You can't store the same alternative several times in the list Every
 * alternative is an integer and corresponds to a voting choice
 */
public class StrictPreference extends Preference {
  ...
  /**
   * @param list a list of alternatives not {@code  null }
